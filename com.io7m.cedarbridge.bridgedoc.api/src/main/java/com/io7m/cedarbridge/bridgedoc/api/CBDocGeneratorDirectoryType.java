...
public interface CBDocGeneratorDirectoryType
{
  /**
   * @return The available documentation generators
   */

  List<CBDocGeneratorFactoryType> availableGenerators();
   ...
   *
   * @return A documentation generator, if any
   */

  default Optional<CBDocGeneratorFactoryType> findByLanguageName(
  ...
  private static boolean languageNameMatches(
    final CBDocGeneratorFactoryType factory,
    final String languageName)
  {
