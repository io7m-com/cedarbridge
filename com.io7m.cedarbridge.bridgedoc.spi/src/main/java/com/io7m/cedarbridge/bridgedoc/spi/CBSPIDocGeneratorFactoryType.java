...
public interface CBSPIDocGeneratorFactoryType
{
  /**
   * @return The description of the documentation generators
   */

  CBSPIDocGeneratorDescription description();
  ...
  CBSPIDocGeneratorType createGenerator(
    CBSPIDocGeneratorConfiguration configuration);
}
