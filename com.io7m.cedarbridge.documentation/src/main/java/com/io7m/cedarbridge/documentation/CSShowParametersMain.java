...
public final class CSShowParametersMain
{
    ...
    throws Exception
  {
    final var classes =
      List.of(
        CBCommandCheck.class,
        CBCommandCompile.class,
        CBCommandDocument.class,
        CBCommandListCodeGenerators.class,
        CBCommandListDocGenerators.class,
        CBCommandVersion.class
      );
    ...
    throws Exception
  {
    ...
    final var parameters =
      classes.stream()
        .flatMap(CSShowParametersMain::parametersOfClass)
    ...
    for (final var p : parameters) {
      showParameter(document, table, p);
    }
