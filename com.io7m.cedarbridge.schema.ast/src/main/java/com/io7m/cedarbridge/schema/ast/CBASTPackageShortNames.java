...
public final class CBASTPackageShortNames extends CBASTNameChecker
{
  /**
   * The checker instance.
   */

  public static final CBASTPackageShortNames INSTANCE = new CBASTPackageShortNames();

  private CBASTPackageShortNames()
  {
    super("[a-z][a-z0-9_]*");
  }
  ...
  public static <T> CBASTPackageShortName<T> of(
