...
public final class CBASTTypeNames extends CBASTNameChecker
{
  /**
   * The checker instance.
   */

  public static final CBASTTypeNames INSTANCE = new CBASTTypeNames();

  private CBASTTypeNames()
  {
    super("[A-Z][a-z0-9A-Z]*");
  }
  ...
  public static <T> CBASTTypeName<T> of(
