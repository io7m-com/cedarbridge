...
public final class CBASTTypeParameterNames extends CBASTNameChecker
{
  /**
   * The checker instance.
   */

  public static final CBASTTypeParameterNames INSTANCE = new CBASTTypeParameterNames();

  private CBASTTypeParameterNames()
  {
    super("[A-Z][A-Z0-9_]*");
  }
  ...
  public static <T> CBASTTypeParameterName<T> of(
