...
@ImmutablesStyleType
@Value.Immutable
public interface CBBoundPackageType
{
  /**
   * @return The name of the package
   */

  CBASTPackageName<CBBindingType> name();

  /**
   * @return The packages imported by this package
   */

  List<CBASTImport<CBBindingType>> imports();

  /**
   * @return The type declarations in the package
   */

  List<CBASTTypeDeclarationType<CBBindingType>> types();
}
