...
/**
 * An abstract implementation of the {@link CBStringsType} interface.
 */

public abstract class CBAbstractStrings implements CBStringsType
{
  private final ResourceBundle resources;

  protected CBAbstractStrings(
