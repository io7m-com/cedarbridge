...
public final class CBTestDirectories
{
  private static final Logger LOGGER =
    LoggerFactory.getLogger(CBTestDirectories.class);

  private CBTestDirectories()
  {
  ...
  {
    final var path =
      Path.of(System.getProperty("java.io.tmpdir")).resolve("cedarbridge");
  ...
  public static Path resourceOf(
    ...
    throws IOException
  {
    final var internal = String.format("/com/io7m/cedarbridge/tests/%s", name);
